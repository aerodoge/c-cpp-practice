...
public:
    ...
    // 获取剩余牌数
    [[nodiscard]] size_t remaining_cards() const noexcept { return DECK_SIZE - current_index_; }

    // 检查是否还有牌
    [[nodiscard]] bool has_cards() const noexcept { return current_index_ < DECK_SIZE; }
